                ...
                <div class="hpanel">
                    ...
                    <div class="panel-body list">
                        <div class="table-responsive project-list">
                            <table class="table table-striped table-bordered table-hover" id="tableCouponAnalytics">
                                <thead>
                                <tr>
                                    <th>유저(멤버) 별명</th>
                                    <th>쿠폰 사용 메뉴</th>
                                	...
                                	<c:when test="${fn:length(list) > 0}">
                                		<c:forEach items="${list }" var="row">
                                			<tr>
                                    			...
                                    			<td>${row.couponAmount }</td>
                                			</tr>
                                		</c:forEach>
                                	</c:when>
                                	<c:otherwise>
                                		<tr>
                        					<td colspan="5">쿠폰을 사용한 주문이 없습니다.</td>
                    					</tr>
                                	</c:otherwise>
                                </c:choose>
                                </tbody>
...
<script>
	...
	$(document).ready(function(){
		...
		// Initializ Table
        $('#tableCouponAnalytics').dataTable( {
        	"order": [[ 3, "desc" ]]
        } );
