                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table cellpadding="1" cellspacing="1" class="table table-bordered table-striped">
                                ...
                                <tr>
                					<th>내용</th>
                					<td><textarea rows="20" cols="100" title="내용" id="CONTENTS" name="CONTENTS"></textarea></td>
            					</tr>
								</tbody>
                            </table>
                            <br/>
                            <a href="#this" id="list"><button type="button" class="btn w-xs btn-default">목록으로</button></a>
                            <a href="#this" id="write"><button type="button" class="btn w-xs btn-primary">작성하기</button></a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#write").on("click", function(e){ //작성 버튼
            e.preventDefault();
            fn_insertBoard($(this));
        });
    });
