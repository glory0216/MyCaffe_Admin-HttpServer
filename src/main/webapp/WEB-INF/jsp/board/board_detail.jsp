                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table cellpadding="1" cellspacing="1" class="table table-bordered table-striped">
            					...
            					<tr>
            						<th>내용</th>
                					<td colspan="3">${map.noticeContents }</td>
            					</tr>
								</tbody>
                            </table>
                            <br/>
                            <a href="#this" id="list"><button type="button" class="btn w-xs btn-default">목록으로</button></a>
    						<a href="#this" id="update"><button type="button" class="btn w-xs btn-primary">수정하기</button></a>
    						<a href="#this" id="delete"><button type="button" class="btn w-xs btn-primary">삭제하기</button></a>
                        </div>
                    </div>
                </div>
            </div>
